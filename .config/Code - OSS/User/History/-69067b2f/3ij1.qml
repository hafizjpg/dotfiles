...
MouseArea {
    ...
    acceptedButtons: Qt.LeftButton | Qt.RightButton
    onClicked: mouse => {
        console.log("TRAY CLICK button=" + mouse.button + " right=" + Qt.RightButton + " left=" + Qt.LeftButton);

        if (mouse.button === Qt.RightButton) {
            console.log("RIGHT BRANCH ENTERED, id=" + trayBtn.modelData.id + " title=" + trayBtn.modelData.title);
        } else {
            console.log("LEFT BRANCH ENTERED");
