...
PanelWindow {
    ...
    implicitHeight: (bar.dashboardOpen || bar.notifCenterOpen) ? 420 : 52
    ...
    // Model histori notifikasi lokal agar tidak hilang saat toast ditutup
    ListModel {
        id: notificationHistoryModel
    }

    // Capture setiap notification yang masuk dari sistem
    Connections {
    ...
    Item {
        ...
        Rectangle {
            ...
            Row {
                ...
                // Wallpaper Picker Toggle Button
                IconButton {
                    id: wallpaperBtn
                    hovered: wpHover.containsMouse
                    activeState: wallpaperPickerWindow.isOpen

                    Text {
                        anchors.centerIn: parent
                        text: "\uf03e"
                        color: wallpaperPickerWindow.isOpen ? bar.ink : (wpHover.containsMouse ? bar.accentGlow : bar.inkDim)
                        font.family: "JetBrainsMono Nerd Font"
                        font.pixelSize: 12
                    }
                    ...
                    MouseArea {
                        ...
                        anchors.fill: parent
                        hoverEnabled: true
                        onClicked: wallpaperPickerWindow.isOpen = !wallpaperPickerWindow.isOpen
                    }
                }
                ...
                IconButton {
                    id: notifToggleBtn
                    hovered: notifHover.containsMouse
                    activeState: bar.notifCenterOpen

                    Text {
                        anchors.centerIn: parent
                        text: "\uf0f3"
                        color: bar.notifCenterOpen ? bar.ink : (notifHover.containsMouse ? bar.accentGlow : bar.inkDim)
                        font.family: "JetBrainsMono Nerd Font"
                        font.pixelSize: 12
                    }
                    ...
                    Rectangle {
                        ...
                        visible: notificationHistoryModel.count > 0
                    }
                    ...
                    MouseArea {
                        ...
                        hoverEnabled: true
                        onClicked: {
                            bar.notifCenterOpen = !bar.notifCenterOpen;
                            if (bar.notifCenterOpen) bar.dashboardOpen = false;
                        }
                    }
                }
                ...
                // Dashboard Control Center Button
                IconButton {
                    id: dashToggleBtn
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            ...
                            if (bar.dashboardOpen) {
                                bar.notifCenterOpen = false;
            ...
            Column {
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        height: 22
                        radius: 6
                        color: clearHover.containsMouse ? bar.surfaceHighlight : "transparent"
                        anchors.verticalCenter: parent.verticalCenter
                        visible: notificationHistoryModel.count > 0
                        ...
                        MouseArea {
                            ...
                            anchors.fill: parent
                            hoverEnabled: true
                            onClicked: notificationHistoryModel.clear()
                        }
                    }
                }
                    ...
                    delegate: Rectangle {
                        ...
                        Row {
                            ...
                            Rectangle {
                                ...
                                height: 20
                                radius: 5
                                color: dismissHover.containsMouse ? "#FF5555" : "transparent"
                                anchors.verticalCenter: parent.verticalCenter
                                ...
                                MouseArea {
                                    ...
                                    anchors.fill: parent
                                    hoverEnabled: true
                                    onClicked: notificationHistoryModel.remove(index)
                                }
                            }
                        }
                    }
