    ...
    Item {
        ...
        Rectangle {
            ...
            Row {
                ...
                IconButton {
                    ...
                    activeState: Local.Shared.dashboardOpen && Local.Shared.dashboardTab === "notifications"
                    ...
                    MouseArea {
                        ...
                        hoverEnabled: true
                        onClicked: {
                            if (Local.Shared.dashboardOpen && Local.Shared.dashboardTab === "notifications") {
        ...
        Rectangle {
            ...
            Item {
                ...
                visible: Local.Shared.dashboardTab === "notifications"
                ...
                Column {
                    ...
                    Row {
                        ...
                        Item { width: parent.width - clearActiveText.implicitWidth; height: 1 }

                        Text {
                            id: clearActiveText
                            text: "Clear all"
                            color: clearActiveHover.containsMouse ? bar.accentGlow : bar.inkDim
                            font.pixelSize: 10
                            font.weight: Font.Medium
                            font.family: "JetBrainsMono Nerd Font"
                            ...
                            MouseArea {
                                ...
                                anchors.fill: parent
                                hoverEnabled: true
                                onClicked: Local.Shared.clearActive()
                            }
                        }
                    }
                    ...
                    ListView {
                        ...
                        clip: true
                        spacing: 6
                        model: Local.Shared.activeNotifications
            ...
            Item {
                ...
                visible: Local.Shared.dashboardTab === "history"

                Column {
                    anchors.centerIn: parent
                    spacing: 6
                    visible: Local.Shared.historyModel.count === 0
                ...
                Column {
                    ...
                    Row {
                        ...
                        Item { width: parent.width - clearHistoryText.implicitWidth; height: 1 }

                        Text {
                            id: clearHistoryText
                            text: "Clear history"
                            color: clearHistoryHover.containsMouse ? bar.accentGlow : bar.inkDim
                            font.pixelSize: 10
                            font.weight: Font.Medium
                            font.family: "JetBrainsMono Nerd Font"
                            ...
                            MouseArea {
                                ...
                                anchors.fill: parent
                                hoverEnabled: true
                                onClicked: Local.Shared.clearHistory()
                            }
                        }
                    }
                    ...
                    ListView {
                        ...
                        clip: true
                        spacing: 6
                        model: Local.Shared.historyModel
                        boundsBehavior: Flickable.StopAtBounds

                        // History entries are a read-only log: no per-item
                        // dismiss button, no action buttons to re-trigger.
                        delegate: NotificationCard {
                            entryData: model
                            dismissible: false
                        }
