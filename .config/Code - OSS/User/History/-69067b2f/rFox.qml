...
PanelWindow {
        ...
        stdout: SplitParser {
            onRead: data => {
                if (data.trim().length > 0)
                    bar.weatherText = data.trim();
                else
                    bar.weatherText = "Weather Unavailable";
            }
        }
    }
    ...
    readonly property color surfaceCard: "#1C1E26"
    ...
    Item {
        ...
        Rectangle {
            ...
            Row {
                ...
                // --- Dashboard Custom Toggle Button ---
                IconButton {
                    id: dashToggleBtn
        ...
        // --- Custom Detailed Dashboard Popover ---
        Rectangle {
            id: dashboardPanel
            width: 280
            height: 190
            ...
            border.color: bar.borderOutline
            visible: opacity > 0
            opacity: bar.dashboardOpen ? 1.0 : 0.0
