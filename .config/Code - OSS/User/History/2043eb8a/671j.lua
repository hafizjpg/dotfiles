...
hl.bind(mainMod .. " + SHIFT + L", hl.dsp.exec_cmd([[bash -c '
    ...
    if [ "$CURRENT" = "lua:masterscrikk" ]; then
        hyprctl keyword general:layout lua:centered_master
    else
        hyprctl keyword general:layout lua:masterscrikk
    fi
']]))

-- CENTERED_MASTER ACTIONS
