...
hl.bind(mainMod .. " + SHIFT + L", hl.dsp.exec_cmd("hyprctl keyword general:layout lua:centered_master || hyprctl keyword general:layout lua:masterscrikk"))
...
-- NAVIGASI MASTERSCRIKK (A/D = Scroll Track, W/S = Directional Focus)
