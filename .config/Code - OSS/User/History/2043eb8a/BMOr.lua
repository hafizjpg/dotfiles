...
-- Enter Resize Submap
hl.bind(mainMod .. " + R", hl.submap("resize"))

-- Keys available while inside the "resize" submap
hl.bind("Left",  hl.dsp.layout("resizewindow", { x = -30, y = 0 }), { submap = "resize", repeating = true })
hl.bind("Right", hl.dsp.layout("resizewindow", { x = 30, y = 0 }),  { submap = "resize", repeating = true })
hl.bind("Up",    hl.dsp.layout("resizewindow", { x = 0, y = -30 }), { submap = "resize", repeating = true })
hl.bind("Down",  hl.dsp.layout("resizewindow", { x = 0, y = 30 }),  { submap = "resize", repeating = true })

hl.bind("A", hl.dsp.layout("resizewindow", { x = -30, y = 0 }), { submap = "resize", repeating = true })
hl.bind("D", hl.dsp.layout("resizewindow", { x = 30, y = 0 }),  { submap = "resize", repeating = true })
hl.bind("W", hl.dsp.layout("resizewindow", { x = 0, y = -30 }), { submap = "resize", repeating = true })
hl.bind("S", hl.dsp.layout("resizewindow", { x = 0, y = 30 }),  { submap = "resize", repeating = true })

-- Exit Submap
hl.bind("Escape", hl.submap("reset"), { submap = "resize" })
hl.bind("Return", hl.submap("reset"), { submap = "resize" })
