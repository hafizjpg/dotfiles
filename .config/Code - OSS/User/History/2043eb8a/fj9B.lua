...
hl.bind(mainMod .. " ALT + Left",  hl.dsp.resizeactive(-30, 0))
hl.bind("SUPER ALT", "Right", hl.dsp.resizeactive(30, 0))
hl.bind("SUPER ALT", "Up",    hl.dsp.resizeactive(0, -30))
hl.bind("SUPER ALT", "Down",  hl.dsp.resizeactive(0, 30))
