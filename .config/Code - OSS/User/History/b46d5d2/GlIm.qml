...
PanelWindow {
    ...
    // Restrict pointer input only to interactive elements when opened,
    // or fall back to zeroArea (pass-through clicks) when closed.
    mask: Region {
    ...
    // -- MPRIS: dynamic active player tracking -------------------------------
    ...
    NotificationServer {
        ...
        onNotification: (notification) => {
            ...
            // Auto-dismiss notification body after its requested timeout (or 8s default)
