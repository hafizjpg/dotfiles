...
hl.config({
    general = {
        ...
        gaps_in     = CFG.gap_in,
        gaps_out    = CFG.gap_out,
        border_size = 2,
        ["col.active_border"]   = "rgba(89b4fadd) rgba(cba6f7dd) 45deg",
        ["col.inactive_border"] = "rgba(45475add)",
    },
    decoration = {
        rounding        = 12,
        active_opacity   = 1.0,
    ...
    animations = {
        enabled = true,
        bezier = { "coolBezier, 0.16, 1, 0.3, 1" },
        animation = {
            "windows, 1, 4, coolBezier",
            "windowsOut, 1, 4, coolBezier, popin 85%",
            "border, 1, 8, default",
            "fade, 1, 4, default",
            "workspaces, 1, 5, coolBezier, slide",
        },
    },
    misc = {
