...
hl.curve("hyperos", { type = "bezier", points = { {0.05, 0.7}, {0.1, 1} } })
 
hl.animation({ leaf = "global",  enabled = true, speed = 10,  bezier = "silk" })
 
hl.animation({ leaf = "windows",   enabled = true, speed = 6.2, spring = "bounce" })
hl.animation({ leaf = "windowsIn", enabled = true, speed = 4.0, bezier = "hyperos", style = "popin 88%" })
hl.animation({ leaf = "windowsOut",enabled = true, speed = 3.2, bezier = "hyperos", style = "popin 92%" })
 
hl.animation({ leaf = "border", enabled = true, speed = 5.2, spring = "bounce" })
 
hl.animation({ leaf = "fadeIn",  enabled = true, speed = 3.6, bezier = "hyperos" })
hl.animation({ leaf = "fadeOut", enabled = true, speed = 2.8, bezier = "hyperos" })
...
hl.animation({ leaf = "zoomFactor", enabled = true, speed = 6.5, bezier = "silk" })R